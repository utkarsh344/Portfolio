...
interface TwcOptions<ThemeName extends string = string> {
    ...
    defaultTheme?: NoInfer<ThemeName> | (string & {});
    strict?: boolean;
}
/**
 ...
 */
declare const resolveTwcConfig: <ThemeName extends string>(config?: TwcConfig<ThemeName>, { produceCssVariable, produceThemeClass, produceThemeVariant, defaultTheme, strict, }?: TwcOptions<ThemeName>) => {
